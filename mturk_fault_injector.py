...
class RedditTopo( Topo ):
	...
	def __init__( self, sw_path, json_path, pcap_dump, **opts ):
		...
		redditHost = self.addHost( 'h1', ip='10.0.0.2/24',mac = "00:04:00:00:00:00", cls=Docker, dimage = "pdawg/reddit_setup_with_opentracing_3steps:latest", dcmd="/sbin/init --startup-event=failsafe-boot", cpuset_cpus = '2' )
		firstHost = self.addHost( 'h2', ip='10.0.1.2/24',mac = "00:04:00:00:00:01", cls=Docker, dimage = "pdawg/cassandra_3users:latest", dcmd="/sbin/init --startup-event=failsafe-boot", cpuset_cpus = '3' )
		...
		secondHost = self.addHost('h8', ip='10.0.2.2/24',mac = "00:04:00:00:00:02", cls=Docker, dimage = "pdawg/reddit_setup_memcache:latest", dcmd="/sbin/init --startup-event=failsafe-boot", cpuset_cpus = '4' )
		thirdHost = self.addHost('h9', ip='10.0.3.2/24',mac = "00:04:00:00:00:03", cls=Docker, dimage = "pdawg/reddit_setup_mcrouter:latest", dcmd="/sbin/init --startup-event=failsafe-boot", cpuset_cpus = '5' )
		fourthHost = self.addHost('h10', ip='10.0.4.2/24',mac = "00:04:00:00:00:04", cls=Docker, dimage = "pdawg/postgres_3users:latest", dcmd="/sbin/init --startup-event=failsafe-boot", cpuset_cpus = '6' )
...
class SockshopTopo( Topo ):
	...
	def __init__( self, sw_path, json_path, pcap_dump, **opts ):
		...
		# Add hosts
		edgerouterHost = self.addHost( 'h1', ip='10.0.0.2/24',mac = "00:04:00:00:00:00", cls=Docker, dimage = "pdawg/weaveworksdemos-edge-router:latest", cpuset_cpus = '0' )
		frontendHost = self.addHost( 'h2', ip='10.0.1.2/24',mac = "00:04:00:00:00:01", cls=Docker, dimage = "pdawg/weaveworksdemos-front-end:latest", cpuset_cpus = '1' )
		catalogueHost = self.addHost( 'h3', ip='10.0.2.2/24',mac = "00:04:00:00:00:02", cls=Docker, dimage = "pdawg/weaveworksdemos-catalogue:latest", cpuset_cpus = '2' )
		cataloguedbHost = self.addHost( 'h4', ip='10.0.3.2/24',mac = "00:04:00:00:00:03", cls=Docker, dimage = "pdawg/weaveworksdemos-catalogue-db:latest", cpuset_cpus = '3' )
		cartsHost = self.addHost( 'h5', ip='10.0.4.2/24',mac = "00:04:00:00:00:04", cls=Docker, dimage = "pdawg/weaveworksdemos-carts:latest", cpuset_cpus = '4' )
		cartsdbHost = self.addHost( 'h6', ip='10.0.5.2/24',mac = "00:04:00:00:00:05", cls=Docker, dimage = "pdawg/weaveworksdemos-mongodb:latest", cpuset_cpus = '5' )
		ordersHost = self.addHost( 'h7', ip='10.0.6.2/24',mac = "00:04:00:00:00:06", cls=Docker, dimage = "pdawg/weaveworksdemos-orders:latest", cpuset_cpus = '6' )
		ordersdbHost = self.addHost( 'h8', ip='10.0.7.2/24',mac = "00:04:00:00:00:07", cls=Docker, dimage = "pdawg/weaveworksdemos-mongodb:latest", cpuset_cpus = '7' )
		shippingHost = self.addHost( 'h9', ip='10.0.8.2/24',mac = "00:04:00:00:00:08", cls=Docker, dimage = "pdawg/weaveworksdemos-shipping:latest", cpuset_cpus = '0' )
		queuemasterHost = self.addHost( 'h10', ip='10.0.9.2/24',mac = "00:04:00:00:00:09", cls=Docker, dimage = "pdawg/weaveworksdemos-queue-master:latest", cpuset_cpus = '1', volumes=["/var/run/docker.sock:/var/run/docker.sock:rw"] )
		rabbitmqHost = self.addHost( 'h11', ip='10.0.10.2/24',mac = "00:04:00:00:00:0a", cls=Docker, dimage = "pdawg/weaveworksdemos-rabbitmq:latest", cpuset_cpus = '2' )
		paymentHost = self.addHost( 'h12', ip='10.0.11.2/24',mac = "00:04:00:00:00:0b", cls=Docker, dimage = "pdawg/weaveworksdemos-payment:latest", cpuset_cpus = '3' )
		userHost = self.addHost( 'h13', ip='10.0.12.2/24',mac = "00:04:00:00:00:0c", cls=Docker, dimage = "pdawg/weaveworksdemos-user:latest", cpuset_cpus = '4' )
		userdbHost = self.addHost( 'h14', ip='10.0.13.2/24',mac = "00:04:00:00:00:0d", cls=Docker, dimage = "pdawg/weaveworksdemos-user-db:latest", cpuset_cpus = '5' )
		usersimulatorHost = self.addHost( 'h15', ip='10.0.14.2/24',mac = "00:04:00:00:00:0e", cls=Docker, dimage = "pdawg/weaveworksdemos-load-test:latest", cpuset_cpus = '6' )
...
def main(fault_no):
	seq_choice = fault_no
	os.mkdir("/home/reddit/Faults/Fault"+str(fault_no))
	...
	net.addLink(nat, net.get('r0'), intfName2='r0-eth9', addr2='00:aa:bb:cc:00:ff', params2={'ip': '172.31.10.10/16'})
	nat.config()
	net.get('nat0').cmd('ip route add 172.31.10.10 dev nat0-eth0')
	...
	net.get('r0').cmd('ip route add 172.17.0.1 dev r0-eth9')
	...
	if choice=="1":
		...
		mcrouterhost.cmd("ps aux | grep mcrouter | awk '{print $2}' | xargs kill -9")
	elif choice=="3":
		...
		router.cmd('sudo iptables -t nat -A PREROUTING -p tcp -s 10.0.1.2 -d 10.0.0.2 -j DNAT --to-destination 10.0.5.2')
	elif choice=="9":
		router.cmd('sudo iptables -t nat -A PREROUTING -p tcp -s 10.0.2.2 -d 10.0.0.2 -j DNAT --to-destination 10.0.5.2')
	elif choice=="10":
		router.cmd('sudo iptables -t nat -A PREROUTING -p tcp -s 10.0.3.2 -d 10.0.0.2 -j DNAT --to-destination 10.0.5.2')
	elif choice=="11":
		router.cmd('sudo iptables -t nat -A PREROUTING -p tcp -s 10.0.4.2 -d 10.0.0.2 -j DNAT --to-destination 10.0.5.2')
	elif choice=="12":
		router.cmd('sudo iptables -t nat -A PREROUTING -p tcp -s 10.0.0.2 -d 10.0.1.2 -j DNAT --to-destination 10.0.5.2')
		router.cmd('sudo iptables -t nat -A PREROUTING -p tcp -s 10.0.0.2 -d 10.0.2.2 -j DNAT --to-destination 10.0.5.2')
		router.cmd('sudo iptables -t nat -A PREROUTING -p tcp -s 10.0.0.2 -d 10.0.3.2 -j DNAT --to-destination 10.0.5.2')
		router.cmd('sudo iptables -t nat -A PREROUTING -p tcp -s 10.0.0.2 -d 10.0.4.2 -j DNAT --to-destination 10.0.5.2')
		router.cmd('sudo iptables -t nat -A PREROUTING -p tcp -s 10.0.0.2 -d 10.0.20.2 -j DNAT --to-destination 10.0.5.2')
	elif choice=="13":
		router.cmd('sudo iptables -t nat -A PREROUTING -p tcp -s 10.0.20.2 -d 10.0.0.2 -j DNAT --to-destination 10.0.5.2')
	elif choice=="15":
		...
		client.cmd("/home/reddit/sourdough/datagrump/udpserver 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.10.244 10000 &")	
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.10.244 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.10.244 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.10.244 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.10.244 10000 &")
		...
		client.cmd("/home/reddit/sourdough/datagrump/udpserver 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.19.245 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.19.245 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.19.245 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.19.245 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.19.245 10000 &")
		...
		client.cmd("/home/reddit/sourdough/datagrump/udpserver 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.13.245 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.13.245 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.13.245 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.13.245 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.13.245 10000 &")
		...
		client.cmd("/home/reddit/sourdough/datagrump/udpserver 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.15.245 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.15.245 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.15.245 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.15.245 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.15.245 10000 &")
		...
		client.cmd("/home/reddit/sourdough/datagrump/udpserver 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.17.245 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.17.245 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.17.245 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.17.245 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.17.245 10000 &")
		...
		client.cmd("/home/reddit/sourdough/datagrump/udpserver 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.41.245 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.41.245 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.41.245 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.41.245 10000 &")
		server.cmd("/home/reddit/sourdough/datagrump/udpclient 10.0.41.245 10000 &")
	...
	os.system('wget http://reddit.local:8090/')
	memcachehost.cmd("echo 'flush_all' | netcat 10.0.2.2 11211")
	
	for iteration_no in range(1,11):
	    os.mkdir("/home/reddit/Faults/Fault"+str(fault_no)+"/iteration"+str(iteration_no))
	    os.system('sudo python external_create_tasks.py --port '+str(args.port)+' > /home/reddit/Faults/Fault' + str(fault_no) + "/iteration" + str(iteration_no) + "/hit_data.txt")
		...
		if data.decode() == "Start":
		    os.system("for i in $( ps ax | awk '/record_register/ {print $1}' ); do kill ${i}; done")
		    os.system('sudo rm -rf results*')
		    os.system('sudo ./record_register.sh 4000 9090 regV_result_f0 &')
	            os.system('sudo ./record_register.sh 4000 9091 regV_result_f0 &')
	            os.system('sudo ./record_register.sh 4000 9092 regV_result_f0 &')
	            os.system('sudo ./record_register.sh 4000 9093 regV_result_f0 &')
	            os.system('sudo ./record_register.sh 4000 9094 regV_result_f0 &')
	            os.system('sudo ./record_register.sh 4000 9095 regV_result_f0 &')
	            os.system('sudo ./record_register.sh 4000 10090 regV_result_f0 &')
	            os.system('sudo ./record_register.sh 4000 10091 regV_result_f0 &')
	            os.system('sudo ./record_register.sh 4000 10092 regV_result_f0 &')
	            os.system('sudo ./record_register.sh 4000 10093 regV_result_f0 &')
	            os.system('sudo ./record_register.sh 4000 10094 regV_result_f0 &')
	            os.system('sudo ./record_register.sh 4000 10095 regV_result_f0 &')
                if data.decode() == "Flush" and fault_no in [2,3,4,7,8,10,11,15,17,18,23,26]:
                    memcachehost.cmd("echo 'flush_all' | netcat 10.0.2.2 11211")
		if data.decode() == "Next Fault":
		    ...
		    with open('/home/reddit/Faults/Fault'+str(fault_no)+'/iteration'+str(iteration_no)+'/traces.json', 'w') as f:
			json.dump(tracescollected, f)
		    os.system('sudo cp *.pcap /home/reddit/Faults/Fault'+str(fault_no)+'/iteration'+str(iteration_no))
		    os.system("for i in $( ps ax | awk '/record_register/ {print $1}' ); do kill ${i}; done")
	            os.system('sudo mv results* /home/reddit/Faults/Fault'+str(fault_no)+'/iteration'+str(iteration_no))
	            sleep(5)
		    break
	os.system("for i in $( ps ax | awk '/record_register/ {print $1}' ); do kill ${i}; done")
...
def sockshop_main(fault_no):
	...
	# Delete this in experiment
	CLI(net)

	# os.system('sudo python https_forwarding/serve_sockshop.py --ip='+args.ip+' --port='+str(args.port))
